...
public class LmrSearchController {

	private final Logger log = LoggerFactory
			.getLogger(LmrSearchController.class);
	@Autowired
	private LmrApplicationProperties applicationProperties;

	@RequestMapping(value = "/searchlocation", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	public ResponseEntity<Object> searchLocation(HttpServletRequest request,
		...
		try {
			result = restTemplate.exchange(
					applicationProperties.getLocationSearchUri(),
