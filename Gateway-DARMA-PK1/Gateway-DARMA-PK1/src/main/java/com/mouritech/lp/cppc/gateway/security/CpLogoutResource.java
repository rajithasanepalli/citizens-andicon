...
public class CpLogoutResource {

	private final Logger log = LoggerFactory.getLogger(CpLogoutResource.class);
	...
	public ResponseEntity<Object> logout(HttpServletRequest request)
		...
		if (apiKey != null
				&& (apiKey.equalsIgnoreCase(cpApplicationProperties
						.getCpIapiKey()) || apiKey
						.equalsIgnoreCase(cpApplicationProperties
								.getCpEapiKey()))) {
		...
		try {
			result = restTemplate.exchange(
					cpApplicationProperties.getCpLogout(), HttpMethod.DELETE,
