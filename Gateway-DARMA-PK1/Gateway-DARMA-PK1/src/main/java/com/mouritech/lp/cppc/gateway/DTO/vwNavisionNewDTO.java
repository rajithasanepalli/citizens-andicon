...
public class vwNavisionNewDTO implements Serializable {
	...
	public String toString() {
		return "vwNavisionNewDTO [id=" + id + ", company=" + company
				+ ", locationId=" + locationId + ", location=" + location
				+ ", GLBaseAccount=" + GLBaseAccount + ", CorE=" + CorE
				+ ", revenueDate=" + revenueDate + ", debits=" + debits
				+ ", credits=" + credits + ", postingDate=" + postingDate
				+ ", filterPostingDate=" + filterPostingDate
				+ ", postednavisiondate=" + postednavisiondate
				+ ", reconciledDate=" + reconciledDate + ", BorG=" + BorG
				+ ", description=" + description + ", exportNavisionDate="
				+ exportNavisionDate + ", markForCorrectionDate="
				+ markForCorrectionDate + ", depositidentifier="
				+ depositidentifier + ", postedBy=" + postedBy + "]";
	}
