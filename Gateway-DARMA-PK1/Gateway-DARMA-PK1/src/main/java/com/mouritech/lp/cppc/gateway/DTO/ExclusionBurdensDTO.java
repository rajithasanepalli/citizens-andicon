...
public class ExclusionBurdensDTO implements Serializable {
	...
	private String mappingLocationId;
	...
	public String getMappingLocationId() {
		return mappingLocationId;
	}

	public void setMappingLocationId(String mappingLocationId) {
		this.mappingLocationId = mappingLocationId;
	}
	...
	public String toString() {
		return "ExclusionBurdensDTO [id=" + id + ", jobDescription=" + jobDescription + ", type=" + type
				+ ", dPercentage=" + dPercentage + ", dGL=" + dGL + ", dEorC=" + dEorC + ", dOffsetEorC=" + dOffsetEorC
				+ ", cPercentage=" + cPercentage + ", cGL=" + cGL + ", cEorC=" + cEorC + ", cOffsetEorC=" + cOffsetEorC
				+ ", offsettingAccount=" + offsettingAccount + ", includingTips=" + includingTips + ", locationDTO="
				+ locationDTO + ", status=" + status + ", mappingLocationId=" + mappingLocationId + ", burdenInfoDTO="
				+ burdenInfoDTO + ", locId=" + locId + ", intracoGLClode=" + intracoGLClode + ", lSIChargeOut="
				+ lSIChargeOut + ", revPercentage=" + revPercentage + ", rateNew=" + rateNew + ", locChargeOut="
				+ locChargeOut + ", revGl=" + revGl + ", segmentCode=" + segmentCode + ", debitAndCreditEqual="
				+ debitAndCreditEqual + "]";
	}
