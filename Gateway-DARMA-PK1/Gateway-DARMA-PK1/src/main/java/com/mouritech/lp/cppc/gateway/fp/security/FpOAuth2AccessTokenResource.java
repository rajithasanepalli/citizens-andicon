package com.mouritech.lp.cppc.gateway.fp.security;
 ...
 */
@RestController
@RequestMapping("fp/oauth2/v1")
public class FpOAuth2AccessTokenResource {

	private final Logger log = LoggerFactory
			.getLogger(FpOAuth2AccessTokenResource.class);
	...
	public ResponseEntity<Object> create(HttpServletRequest request,
		...
		if (apiKey != null
				&& (apiKey.equalsIgnoreCase(fpApplicationProperties.getFpApiKey()))) {
		...
		try {
			result = restTemplate.exchange(
					fpApplicationProperties.getFpAccessTokenUri() + urlParam,
