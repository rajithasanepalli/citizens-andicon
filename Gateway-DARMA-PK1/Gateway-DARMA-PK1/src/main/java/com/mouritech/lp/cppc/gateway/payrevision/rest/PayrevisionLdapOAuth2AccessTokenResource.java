 ...
 */
@RestController
@RequestMapping("payrevision/ldap/oauth2/v1")
public class PayrevisionLdapOAuth2AccessTokenResource {

	private final Logger log = LoggerFactory
			.getLogger(PayrevisionLdapOAuth2AccessTokenResource.class);
	@Autowired
	...
	public ResponseEntity<Object> create(HttpServletRequest request,
		...
		if (apiKey != null
				&& (apiKey.equalsIgnoreCase(payrevisionApplicationProperties.getApiKey()))) {
